...
namespace WebApplication2.App_Start
{
   ...
   // using BusniessLogic.Infrastructure;
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            var modules = new INinjectModule[] { new BusniessLogic.Infrastructure.ServiceModule("MyDBConection") };
        ...
        {
            System.Web.Mvc.DependencyResolver.SetResolver(new WebApplication2.Utils.NinjectDR(kernel));
        }        
    }
}
